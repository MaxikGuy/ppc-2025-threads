...
TEST(savchenko_m_radix_sort_omp, func_test2) {
	const size_t n = 100000;
	const int min = 0;
...
TEST(savchenko_m_radix_sort_omp, func_test3) {
	const size_t n = 100000;
	const int min = -100;
	const int max = 0;
...
TEST(savchenko_m_radix_sort_omp, func_test4) {
	const size_t n = 100000;
...
TEST(savchenko_m_radix_sort_omp, func_test5) {
	const size_t n = 100000;
	const int min = -100;
	const int max = 100;
...
TEST(savchenko_m_radix_sort_omp, func_test6) {
	const size_t n = 100000;
	const int min = -10000000;
	const int max = 10000000;
...
TEST(savchenko_m_radix_sort_omp, MIN_MAX_INT) {
	const size_t n = 100000;
