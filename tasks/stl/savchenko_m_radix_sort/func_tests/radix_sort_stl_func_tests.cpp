...
TEST(savchenko_m_radix_sort_stl, simple1) {
	const size_t n = 20;
	const int min = 0;
	const int max = 100;
...
TEST(savchenko_m_radix_sort_stl, simple2) {
	const size_t n = 20;
	const int min = -100;
	const int max = 100;
...
TEST(savchenko_m_radix_sort_stl, func_test1) {
...
TEST(savchenko_m_radix_sort_stl, func_test2) {
	const size_t n = 100000;
	const int min = 0;
...
TEST(savchenko_m_radix_sort_stl, func_test3) {
	const size_t n = 100000;
	const int min = -100;
	const int max = 0;
...
TEST(savchenko_m_radix_sort_stl, func_test4) {
	const size_t n = 100000;
...
TEST(savchenko_m_radix_sort_stl, func_test5) {
	const size_t n = 100000;
	const int min = -100;
	const int max = 100;
...
TEST(savchenko_m_radix_sort_stl, func_test6) {
	const size_t n = 100000;
	const int min = -10000000;
	const int max = 10000000;
...
TEST(savchenko_m_radix_sort_stl, MIN_MAX_INT) {
	const size_t n = 100000;
